...
let Autocomplete = React.createClass({
  ...
  handleChange (event) {
    ...
    if (warnAboutOnChange) {
      warnAboutOnChange = false
      warning(
        this.props.onChange.length === 1,
        'The second argument to `Autocomplete.props.onChange` is going away: git.io/TODO'
      )
    }
    ...
    return (
      <div style={{...this.props.wrapperStyle}} {...this.props.wrapperProps}>
        <input
          ...
          autoComplete="off"
          ref="input"
          onFocus={this.composeEventHandlers(this.handleInputFocus, props.onFocus)}
          onBlur={this.composeEventHandlers(this.handleInputBlur, props.onBlur)}
          onChange={this.handleChange}
          onKeyDown={this.composeEventHandlers(this.handleKeyDown, props.onKeyDown)}
          onKeyUp={this.composeEventHandlers(this.handleKeyUp, props.onKeyUp)}
          onClick={this.composeEventHandlers(this.handleInputClick, props.onClick)}
        />
